    ...
    <div class="m-modal m-modal__xl is--active">
      <div class="m-modal__error">
        <div class="is--denko__container m-row">
          <ul>
            <li class="is--denko">
              <span class="m-lead">Ne paniquez pas</span>
              <span class="m-lead">Ceci est une Erreur QuinzeMilleQuatre</span>
              <span class="m-lead">Ce n'est pas exercice</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="m-modal__msg">
        <p class="m-lead">La Base de données ne répond pas.</p>
        <div class="divider"></div>
        <p class="m-body-l">Ne paniquez pas : Nadine a déjà des solutions. Sélectionnez votre scenario :</p>
        <p class="m-body"><a data-toggle="m-modal" data-target=".m-modal__s">01 — Tout va bien : je lance Nadine pour la première fois. C'est donc normal que la Base de données soit vide et que Nadine panique un peu. Je veux continuer l'installation automatique.</a></p>
        <p class="m-body"><a href="https://discord.gg/Fg2m8gvdWR" target="_blank">02 — J'ai le plaisir d'utiliser Nadine quotidiennement. C'est donc que quelque chose ne vas pas. Je contacte les équipes de NadineCorp© qui se feront une joie de me dépanner gratuitement.</a></p>
      </div>
    </div>

    <div class="m-modal m-modal__s m-alerte">
      <div class="m-modal__msg">
        <p class="m-lead">Suppression imminente</p>
        <p class="m-body-l">Confirmez la réinstallation automatique de la Base de données en tapant <em>KonMari</em> ci-dessous.</p>
        <p class="m-body">Pas besoin de répéter deux fois la même chose à Nadine : si vous avez déjà utilisé Nadine, toutes vos données seront perdu à jamais.</p>
