    ...
    <?php if ($result->num_rows > 0): ?>
      ...
      <form class="form body" action="./core/update__diffuseur.php" method="post">
        <div class="form__input-container">
          ...
          <a href="./diffuseurs.php" class="btn btn__outline">Annuler</a>
          <a href="./core/supprimer.php?base=diffuseurs&location=diffuseurs&cible=diffuseur__id&id=<?php echo $diffuseur__id ?>" class="btn btn__outline">Supprimer</a>
