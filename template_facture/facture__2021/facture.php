    ...
    <div class="paper__content">
      ...
      <table class="facture__h-100 facture__b-t">
        <tr>
          ...
          <td class="facture__w-10 facture__tr"><p class="facture__caption"><input type="text" name="contribution-secu-sociales" placeholder="Montant" class="facture__caption form__input--line-through" disabled> €  <input type="text" name="contribution-secu-sociales-new" placeholder="Montant" class="facture__caption" disabled> €</p></td>
        ...
        <tr>
          <td class="facture__w-40 facture__tl"><p class="facture__caption">Cotisation vieillesse plafonnée : 6,90 % (si Montant HT est inférieur à 41 136 €)<br>Prise en charge par l'Etat : 0.75%</p></td>
          <td class="facture__w-10 facture__tr"><p class="facture__caption"><input type="text" name="cotisation-maladies-vieillesse" placeholder="Montant" class="facture__caption form__input--line-through" disabled> €  <input type="text" name="cotisation-maladies-vieillesse-new" placeholder="Montant" class="facture__caption" disabled> €</p></td>
