  ...
  <div class="paper">
    <div class="paper__content">
      ...
      <table class="facture__footer facture__b-t">
        <tr>
          <td>
            <p class="facture__body">Délai de paiement : 7 jours francs dès réception de la facture | Date de réception de la facture : <?php echo $today ?> | Date limite de règlement : <?php echo date($today) . date('d/m/Y', strtotime($today . "+7 day")); ?> </p>
