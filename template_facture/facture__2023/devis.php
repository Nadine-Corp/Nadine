      ...
      <table>
        ...
        <tr>
          <td class="facture__h-100 facture__bl facture__w-25">
            <p class="facture__body">Devis n°<input type="text" name="facture__numero" placeholder="Numéro de facture" class="facture__body" style="text-align:left;" value="<?php the_facture_numero($row, $table); ?>
        "></p>
          </td>
