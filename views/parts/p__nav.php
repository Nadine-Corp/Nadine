...
// Ce fichier controle le volet de navigation principale
// C'est un peu le hall d'entrée de Nadine, le Grand Carrefour.
...
<header class="l-header">
  ...
  <div class="l-header__bar l-header__navbar">
    ...
    <div class="l-header__mention l-header__bottom m-body-s">
      ...
      <span>Version : Nadine Alpha <?php echo get_num_version(); ?></span>
    </div>
  </div>
