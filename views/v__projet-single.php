      ...
      <section class="m-rom">
        ...
        <div class="m-accordion is--active">
          ...
          <div class="m-accordion__wrapper">
            ...
            ?>
            <a href="./facture-single?projet__id=<?php echo $projet__id ?>&devis__id=new" class="p-facture xxs6 m4 l3 xl2 btn btn__big btn__plain">
        ...
        <div class="m-accordion">
          ...
          <div class="m-accordion__wrapper">
            ...
            ?>
            <a href="./facture-single?projet__id=<?php echo $projet__id ?>&facturea__id=new" class="p-facture xxs6 m4 l3 xl2 btn btn__big btn__plain">
              <div class="p-facture__paper">
                <div class="is--fullsize">
                  <div class="btn__big-ico"><?php include './assets/img/ico_ajouter--plain.svg.php'; ?></div>
                  <div class="btn__big-txt">
        ...
        <div class="m-accordion is--active">
          ...
          <div class="m-accordion__wrapper">
            ...
            <?php // Ajout du bouton Ajouter une Facture 
            ?>
            <a href="./facture-single?projet__id=<?php echo $projet__id ?>&facture__id=new" class="p-facture xxs6 m4 l3 xl2 btn btn__big btn__plain">
              <div class="p-facture__paper">
                <div class="is--fullsize">
                  <div class="btn__big-ico"><?php include './assets/img/ico_ajouter--plain.svg.php'; ?></div>
                  <div class="btn__big-txt">
