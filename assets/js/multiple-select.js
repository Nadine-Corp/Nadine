    ...
    selectors.forEach((item, index) => {
        ...
        function singleSelect(){
            ...
            <div class="directorist-select__label">
                ...
                <span class="directorist-select__label--icon"><img src="./assets/img/angle-down-solid.svg" alt=""></span>
            </div>
            <div class="directorist-select__dropdown">
                <input class='directorist-select__search ${ isSearch ? 'directorist-select__search--show' : 'directorist-select__search--hide' }' type='text' class='value' placeholder='Rechercher un Diffuseur' />
            ...
            option.forEach((el, index) => {
                ...
                if(el.hasAttribute('selected')){
                    selectTrigger.innerHTML = el.innerHTML +'<img src="./assets/img/angle-down-solid.svg" alt="">';
                };
            });
            ...
            selectTrigger.addEventListener('click', (e) => {
                ...
                li.forEach((el, index) => {
                    el.addEventListener('click', (event) => {
                        ...
                        sibling.querySelector('.directorist-select__dropdown').classList.remove('directorist-select__dropdown-open');
                        item.querySelector('.directorist-select__label').innerHTML = el.querySelector('.directorist-select-dropdown-text').textContent +'<img src="./assets/img/angle-down-solid.svg" alt="">';
                    });
                });
            });
        ...
        function multiSelects(){
            ...
            <div class="directorist-select__label">
                ...
                <input type="text" class='directorist-select__search ${ isSearch ? 'directorist-select__search--show' : 'directorist-select__search--hide' }' type='text' class='value' placeholder='Rechercher un Artistes' />
            </div>
            <div class="directorist-select__dropdown">
                <div class="directorist-select__dropdown--inner"></div>
            </div>
