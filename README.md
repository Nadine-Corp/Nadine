...
Nadine, c'est pas une arnaque. C'est gratuit et le restera pour toute la vie. Jamais elle ne vous quittera.
...
1. Grace à votre nouveau logiciel, [apprenez et créez une base de données](https://www.google.com/search?q=comment+cr%C3%A9er+une+base+de+donn%C3%A9e+avec+wamp). Vous pouvez l'appeler *nadine* si vous le souhaitez.
